...
public:
	...
	static FORCEINLINE RBMatrix get_ortho(f32 left,f32 right,f32 bottom,f32 top,f32 near,f32 far,f32 scale=1.f);
...
RBMatrix RBMatrix::get_ortho(f32 left,f32 right,f32 bottom,f32 top,f32 n,f32 f,f32 scale)
{
	f32 w = right - left;
	f32 h = top - bottom;
	return RBMatrix(
